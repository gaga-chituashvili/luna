...
export const Header = () => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 w-full z-50 shadow-lg bg-gradient-to-r from-[#2b1b16] via-[#1a0f0c] to-black text-white transition-transform duration-300 ${visible ? "translate-y-0" : "-translate-y-full"}`}
      >
