...
export const Shop = () => {
  ...
  return (
    <section className="w-full min-h-[80vh] flex items-center pt-24 text-white bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#2b1b16] via-[#1a0f0c] to-black">
      <Wrapper className="flex flex-col lg:flex-row items-center justify-between gap-12">
        <motion.article
        ...
        >
          ...
          >
            <Button
              onClick={() => navigate({ to: ROUTES.shop })}
              variant="default"
            >
              {HOME_HERO.buttons.shop}
            </Button>
            <Button
