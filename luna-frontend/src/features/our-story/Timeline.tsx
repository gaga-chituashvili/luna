    ...
    <section className="py-24 bg-gradient-to-b from-[#0f0f0f] to-[#1a1410]">
      <Wrapper>
        ...
        <div className="relative">
          <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-gradient-to-b from-[#B8735A] to-transparent hidden md:block"></div>
            ...
            {TIMELINE.map((event, index) => (
              ...
              >
                ...
                <div className={`w-full md:w-5/12 ${index % 2 === 0 ? "md:pr-16" : "md:pl-16"}`}>
                  ...
                  >
                    <span className="inline-block px-4 py-1 mb-4 text-sm font-semibold bg-[#B8735A]/20 text-[#B8735A] rounded-full md:hidden">
                      {event.year}
                    </span>
                    <h3 className="text-2xl font-bold mb-3 text-[#B8735A]">{event.title}</h3>
